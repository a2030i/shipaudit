...
جسم الدالة النهائي موحد في الخطوة الأولى لبناء قاعدة جديدة من الصفر، والخطوتان التاليتان تثبتان عقدي منتصف الليل والترتيب مع الحفاظ على تطابق تاريخ Production.
