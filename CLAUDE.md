...
- **أكورديون قسم-واحد (v4 — 2026-07-02):** فتح قسم **يقفل كل البقية** («لو فتحت قسم مفروض يقفل قسم»). الافتراضي: كله مقفل عدا شركات الشحن. المفتاح `sa-nav-collapsed-v4` يطبّق الافتراض مرة لكل مستخدم. الطيّ عبر `maxHeight:0` لا unmount.
