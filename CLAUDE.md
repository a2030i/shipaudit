...
- **سعر البيع فارغ** حالياً (عمود قابل للإدخال) — يُملأ لاحقاً من إكسل الأسعار اللايف. ثابت/ATAQ مفعّلان بلا عقد (تكلفة «—» حتى يُدخَل عقدهما).
- **قاعدة**: التكلفة لا تُخزَّن — تتبع العقد. أي مصدر سعر بيع جديد يُكتب في `platform_carriers.sell_price` لا في مكان آخر.
