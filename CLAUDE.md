...
**الاستنتاج التشغيلي**: القصف الجماعي لأرقام الدلائل الباردة هو ما يحرق تصنيف رقمك — عائده **1.8% ردّ** مقابل **13.5%** لحملة موجَّهة لتجّارك. نفس النمط في بُعد الحملة (كل حملات «جهات محتملة» 20–22% خنق).
