...
- `customer_ar.opening_due` رصيد افتتاحي بعمر غير معروف؛ يظهر في شريحة مستقلة باسم «رصيد افتتاحي»، ولا يدخل في «متأخر» أو شريحة `+90` ولا يغيّر «أقدم استحقاق».
- إجمالي المستحق يظل شاملًا للفواتير المفتوحة والرصيد الافتتاحي؛ الفصل يغيّر التصنيف والعمر فقط ولا يسقط المبلغ من ذمة العميل.
