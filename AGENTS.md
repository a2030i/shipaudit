...
- الفاصل الحقيقي جزء مباشر من حاوية flex المطلقة، لذلك يدخل في `scrollHeight` على Safari؛ قيمة الأمان تشمل شريط التنقل و`safe-area-inset-bottom`.
- غلاف محتوى الصفحة المباشر داخل `.page-slot` لا يجوز أن ينكمش (`flex-shrink: 0`)؛ انكماشه يُبقي overflow ظاهرًا لكنه يضع فاصل النهاية قبل آخر المحتوى ويعيد قص الأزرار.
