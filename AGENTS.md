...
- **محرّك التوجيه التجاري (2026-07-31):** `v_platform_commercial_routing` يفصل `live/live2` كربط متجر مباشر عالي النية، و`webhook/zapier` كتكامل آلي، والفارغ كتسجيل يدوي. الإشارات اليومية: ربط مباشر خلال 5 أيام بلا أول شحنة · انقطاع شحن 1–5 أيام · رصيد موجب بلا شحن حديث · ربط مباشر غير نشط.
