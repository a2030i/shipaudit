...
## تحديث 2026-08-01 — دمج المراكز (المرحلة الثانية)
...
- مركز `/carriers` في قسم الإعدادات يجمع: شركات الشحن · العقود والأسعار · الفريق والصلاحيات (الأخير للمدير فقط). `/contracts` و`/employees` روابط متوافقة وليست مداخل جانبية.
- القائمة الظاهرة أصبحت 19 مدخلاً. سجل المسارات والصلاحيات لم يُحذف، و`navHidden` لا يعني إسقاط الحارس.
