...
- أسماء قسم العملاء تصف **وظيفة الشاشة** لا نوع الحاوية: `ملفات العملاء` · `الديون والتحصيل` · `فرص البيع` · `الصفقات والمتابعات` · `خدمة العملاء` · `مهام العملاء اليوم`. لا تستخدم «مركز» أو «متابعة» وحدها في مسمى جديد.
...
- بطاقة «ردود الحملات» في `/sales` مصدرها مهام `crm_tasks` المفتوحة الناتجة عن رد حقيقي آخر 48 ساعة، لا كل صفوف `whatsapp_campaign_sends.replied_at`. وجود الرد وحده لا يعني أن فريق هاتف لم يعالجه؛ تعرض البطاقة حالة الإسناد في هاتف ورابط المحادثة إن توفر.
