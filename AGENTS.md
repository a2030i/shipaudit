...
- `integration_health` يعمل كل ساعة عند الدقيقة 5 افتراضيًا، ويراقب حداثة زوهو وهاتف وبيانات المنصة، Webhooks العالقة/الفاشلة، تشغيلات مزامنة زوهو الفاشلة، ووجود Cron نشط.
