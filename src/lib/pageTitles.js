...
export const PAGE_TITLES = {
  ...
  '/workspace/operations': 'مركز التشغيل',
  '/workspace/customers': 'العملاء والمتاجر',
  '/workspace/sales':   'المبيعات',
  '/workspace/campaigns': 'الحملات',
  '/workspace/finance': 'المركز المالي',
  '/workspace/admin': 'الإدارة والإعدادات',
  ...
  '/reports':           'التقارير',
  '/workspace/reports': 'التقارير والتحليلات',
