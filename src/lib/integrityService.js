...
export const CHECK_META = {
  ...
  zoho_debt_no_invoices: {
    label: 'رصيد افتتاحي بلا فاتورة تقابله',
    desc:  'زوهو يسجّل رصيداً مستحقاً على العميل لا تقابله فاتورة مفتوحة — رصيد سابق مرحّل. صار **محتسَباً** في كل شاشات الدين والتحصيل والحملات، لكنه يبقى بلا مستند: أصدر له فاتورة في زوهو أو سوِّه ليصبح مؤرَّخاً وقابلاً للأعمار.',
  ...
  store_link_ghost: {
    label: 'عميل مربوط بمتجر شبح (صفر شحنة)',
    desc:  'رابط العميل يشير لمتجر مكرَّر بصفر شحنة بينما المتجر الحقيقي بنفس الاسم يشحن — فالهاتف والمحفظة ونوع الفوترة كلها من متجر خاطئ. الروابط التلقائية أُصلحت آلياً؛ ما يبقى هنا **يدوي** ويحتاج تعديلك من دليل المتاجر.',
    severity: 'red', goto: '/merchants',
  },
  store_name_collision: {
    label: 'متجران بنفس الاسم وكلاهما يشحن',
    desc:  'اسمان متطابقان بعد التطبيع ولكليهما شحنات فعلية — لا يمكن حسم أيّهما صاحب الرصيد آلياً. ميّز الاسمين في المنصّة أو ادمج المتجرين، وإلى أن يحدث ذلك راجع ربط هؤلاء يدوياً.',
    severity: 'amber', goto: '/merchants',
  },
};
