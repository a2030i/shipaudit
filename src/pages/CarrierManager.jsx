    ...
    <div style={{background:'var(--surface)',border:'1px solid var(--border)',borderRadius:9,padding:'12px 14px',marginBottom:10}}>
      ...
      <div style={{display:'flex',alignItems:'center',gap:6,marginBottom:10}}>
        ...
        <button onClick={multiType ? toSingle : toMulti}
          ...
          style={{
            background: multiType ? 'color-mix(in srgb, var(--accent) 12%, transparent)' : 'transparent',
            border:`1px solid ${multiType?'color-mix(in srgb, var(--accent) 30%, transparent)':'var(--border)'}`,
            ...
            <div style={{maxHeight:230,overflowY:'auto',padding:'12px 14px',display:'flex',flexDirection:'column',gap:8}}>
              {chatMsgs.map((m,i)=>(
                <div key={i} style={{
                  ...
                  maxWidth:    '88%',
                  background:  m.role==='user'?'color-mix(in srgb, var(--accent) 12%, transparent)':'var(--surface)',
                  border:      `1px solid ${m.role==='user'?'color-mix(in srgb, var(--accent) 25%, transparent)':'var(--border)'}`,
