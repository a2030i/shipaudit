-- A single, review-first engagement queue for Hatif + Lamha customer signals.
-- The function is SECURITY DEFINER because its decision needs restricted campaign,
-- call and finance sources. Access is checked explicitly before any row is returned.
...
as $function$
  ...
  where a.allowed
    ...
    and (p_journey is null or g.journey = p_journey)
