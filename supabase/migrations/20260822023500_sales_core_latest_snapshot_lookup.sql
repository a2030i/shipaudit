-- Sales Core: use the existing uploaded_at index to resolve the newest merchant snapshot.
-- This is definition-preserving: Production grouped and indexed lookups resolve the same snapshot.
