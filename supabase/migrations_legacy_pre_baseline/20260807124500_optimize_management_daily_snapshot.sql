-- Keep the daily management report comfortably below the Edge Function RPC timeout.
-- Each source is scanned once, instead of issuing several independent aggregate scans.
...
set next_run_at = (
  date_trunc('day', now() at time zone 'Asia/Riyadh') + interval '1 day 10 hours'
