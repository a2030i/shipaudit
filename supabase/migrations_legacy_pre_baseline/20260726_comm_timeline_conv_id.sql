-- إضافة conversation_id لسجلّ تواصل العميل — لرابط «افتح المحادثة في هاتف»
-- (app.hatif.io/ar/inbox?channelId=..&conversationId=..). 2026-07-26.
drop function if exists public.customer_comm_timeline(text);
create function public.customer_comm_timeline(p_phone text)
returns table(
