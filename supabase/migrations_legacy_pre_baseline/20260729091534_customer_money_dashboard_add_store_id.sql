-- إضافة `store_id` لصفوف العملاء — طلب المستخدم: رقم المتجر في نظام لمحة
-- يجب أن يظهر في ملف Excel، فهو المفتاح الذي يُبحَث به في المنصّة الداخلية
-- (الاسم قد يتكرّر — حالة «Smart» §1.53 — والرقم لا يتكرّر).
-- إضافة صرفة: كل المفاتيح القائمة سليمة.
